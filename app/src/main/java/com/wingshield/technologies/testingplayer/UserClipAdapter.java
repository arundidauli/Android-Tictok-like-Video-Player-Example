...
public class UserClipAdapter extends RecyclerView.Adapter<UserClipAdapter.MyViewHolder> {
    private static String TAG = UserClipAdapter.class.getSimpleName();
    private Context context;
    private List<UserClips> userClipsList;
    public UserClipAdapter(Context context, List<UserClips> userClipsList) {
